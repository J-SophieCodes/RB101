...
expected. Run the code and observe its behavior. Can you figure 
out what is wrong?
=end
...
def guess_number(max_number, max_attempts)
  ...
  loop do
    ...
    if guess == winning_number
      puts 'Yes! You win.'
      return  # need to exit program when won
    else
      puts 'Nope. Too small.' if guess < winning_number
      puts 'Nope. Too big.'   if guess > winning_number

      # Try again:
      # guess_number(max_number, max_attempts) # restarts everything
    end
  end
